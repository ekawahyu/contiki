 ...
 */
void
flash_write_DMA(uint8_t *data, uint16_t length, uint16_t flashwordadr)
{
  DMA_DESC dmaConfig0;
 ...
 */
void
flash_read(uint8_t pg, uint16_t offset, uint8_t *buf, uint16_t size)
{
